...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--2-1!../../node_modules/sass-loader/lib/loader.js??ref--2-2!./main.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--2-1!../../node_modules/sass-loader/lib/loader.js??ref--2-2!./main.scss");
...
var Link = (function (_super) {
    ...
    function Link(props) {
        var _this = _super.call(this, props) || this;
        _this.onMouseEnter = function (e) {
            _this.setState({ text: 'Link Hovering' });
        };
        _this.onMouseLeave = function (e) {
            _this.setState({ text: 'Link' });
        };
        _this.state = {
            text: 'Link'
        };
    ...
    Link.prototype.render = function () {
        return (React.createElement("a", { href: "#", onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave }, this.state.text));
    };
    return Link;
}(React.Component));
